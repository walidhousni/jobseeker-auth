...
import { BadRequestError, IAuthDocument } from "@walidhousni/jobseeker-shared";
...
export async function update(req: Request, res: Response): Promise<void> {
    ...
    if (!checkIfUserExist) {
        throw new BadRequestError('Verification token is either invalid or is already used', 'VerifyEmail update()  method is invalid')
    }
